"""
FOOTBALL PREDICTOR V4 - HISTORICAL xG VERSION

Uses historical xG data matched to each season
Full dataset (900+ matches) with correct xG alignment
...
class FootballPredictorV4Historical:
    """Ultimate Football Predictor with Historical xG Data"""
    
    def __init__(self, league='Premier League'):
        self.engine = PredictionEngine(f"Football V4 Historical - {league}")
        self.league = league
        self.match_data = None
        self.xg_scraper = HistoricalXGScraper()
        
        print("🎯 Initializing ULTIMATE Prediction System V4 (Historical)...")
        print("   Features: Form + Historical npxG + xG/shot + Shots + Set Pieces")
    ...
    def load_historical_xg(self, seasons=['2022-2023', '2023-2024', '2024-2025']):
        """Load historical xG for all seasons"""
    ...
    def create_match_features(self, home_team, away_team, match_date=None):
        """Create ULTIMATE feature set with HISTORICAL xG"""
        ...
        # ✨ HISTORICAL advanced stats (matched to correct season!)
    ...
    def prepare_training_data(self, min_games=10):
        """Prepare training data with HISTORICAL xG"""
        
        print("\n📊 Preparing ULTIMATE training data (V4 Historical)...")
        ...
        print(f"   Features: {len(feature_names)} (ULTIMATE V4 Historical)")
    ...
    def train_model(self, test_split=0.2):
        """Train V4 Historical model"""
        
        print("\n🧠 Training V4 Historical Model...")
        print("=" * 70)
        ...
        print(f"\n📊 V4 Historical Model Performance:")
        ...
        if test_acc > v3_baseline:
            ...
            print(f"   Current vs V3: {improvement:+.1f}%")
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("🎯 FOOTBALL PREDICTOR V4 - HISTORICAL xG")
    print("=" * 70)
    ...
    if data is not None:
        ...
        # Create V4 predictor
        predictor = FootballPredictorV4Historical('Premier League')
        predictor.load_data(clean_data)
        
        # Load HISTORICAL xG (already cached!)
